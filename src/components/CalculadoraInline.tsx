  ...
  return (
    <div className="mx-auto w-full max-w-[720px]">
        ...
        <div className="relative mt-8 overflow-x-clip">
          <AnimatePresence initial={false}>
            <motion.div
              ...
              exit={{ opacity: 0, x: -60, position: "absolute", inset: 0 }}
      ...
      <p className="mt-6 text-center font-sans text-[11px] leading-relaxed text-tayah-text-muted">
        Suas respostas ficam armazenadas apenas no seu navegador até você enviar
        os dados no final. Estimativa preliminar — não constitui parecer fiscal.
      </p>
    </div>
  );
}
